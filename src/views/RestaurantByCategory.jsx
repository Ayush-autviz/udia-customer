...
const RestaurantByCategory = (props) => {
  ...
  const get_restaurant_category_list = async () => {
    console.log({customer_id:global.id, category_id:id, lat:props.current_lat, lng:props.current_lng})
    setLoading(true);
    await axios({
      method: 'post', 
        ...
        {count == 0 ?
          <View style={{marginTop:'30%'}}>
            <View style={{ height:250 }}>
              <LottieView style={{flex: 1}} source={empty_menu_lottie} autoPlay loop />
            </View>
