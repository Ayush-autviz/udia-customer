      ...
      <ScrollView showsVerticalScrollIndicator={false} style={{ padding: 10 }}>
        ...
        {global.id != 0 &&
          <View>
            ...
            <View style={{backgroundColor:colors.theme_bg_three,elevation:3,margin:5,borderRadius:10,padding:5}}>
        ...
        {global.id != 0 ?
          <TouchableOpacity onPress={next.bind(this, 'Logout')}>
            <View style={{ flexDirection: 'row', borderBottomWidth: 1, borderColor: colors.light_grey, paddingTop: 15, paddingBottom: 15 }}>
              <View style={{ width: '10%', justifyContent: 'center', alignItems: 'flex-start' }}>
                <Icon type={Icons.Ionicons} name="log-out-outline" color={colors.grey} style={{ fontSize: 20 }} />
              </View>
              <TouchableOpacity activeOpacity={1} onPress={() => { showDialog() }} style={{ width: '85%', justifyContent: 'center', alignItems: 'flex-start' }}>
        ...
        {/* <Modal animationType='slide' visible={showModal}>
          <View style={{
            margin: 20, backgroundColor: colors.theme_bg_three, borderRadius: 20, paddingTop: 35, paddingBottom: 10, alignItems: "center", justifyContent: 'center', shadowColor: "#000",
