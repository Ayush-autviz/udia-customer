      ...
      <View style={{ height: '100%' }}>
        ...
        <View style={{ width: '100%', flexDirection: 'row', height: 60, padding: 10, backgroundColor: colors.light_grey, position: 'absolute', bottom: 0 }}>
          <View style={{ width: '10%', justifyContent: 'center', alignItems: 'center' }}>
            <Icon type={Icons.Ionicons} name="home-outline" color={colors.grey} style={{ fontSize: 15 }} />
          </View>
          <View style={{ width: '85%', justifyContent: 'center', alignItems: 'flex-start' }}>
            <Text style={{ fontFamily: regular, fontSize: 12, color: colors.grey }}>{app_details.address}</Text>
          </View>
        </View>
      </View>
    </SafeAreaView>
