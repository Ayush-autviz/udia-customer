    ...
    <View style={styles.header}>
      ...
      <TouchableOpacity onPress={select_photo.bind(this)} style={styles.box}>
        <View onPress={select_photo.bind(this)} style={styles.profile} >
          <Image style= {{ height: undefined,width: undefined, flex:1, borderRadius:50, borderWidth: 3,borderColor: colors.theme_bg }} source={{ uri : img_url + props.profile_picture}} />
        </View>
      </TouchableOpacity>
      <View style={{ margin:10 }}/>
